            ...
            >
              ...
              <motion.div
                animate={{
                  background: [
                    ...
                    'linear-gradient(135deg, rgba(147, 51, 234, 0.1), rgba(244, 63, 94, 0.1))',
                    'linear-gradient(135deg, rgba(244, 63, 94, 0.1), rgba(37, 99, 235, 0.1))',
                  ],
                }}
              ...
              <div className="relative p-8">
                ...
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Запросить образец</h2>
                    <p className="text-sm text-gray-600 mt-1">Продукт: {productName}</p>
                  </div>
                  <button
                    onClick={onClose}
