    ...
    <section className="relative py-20 bg-[url('/images/main/bg_services.png')] bg-center bg-cover">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
        ...
        <motion.p
          ...
          className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto mb-12"
        >
          ООО "ПСК "Буртехнологии" имеет право на применение запатентованных технологий и рецептур в области буровых и тампонажных растворов в рамках лицензионного договора с ООО "Лукойл-Инжиниринг" "ПермНИПИнефть".
        </motion.p>
