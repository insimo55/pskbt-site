...
export const metadata: Metadata = {
  title: "О компании",
  description:
    "Более 20 лет опыта в области буровых растворов, технологических жидкостей и цементирования скважин.",
};
...
//       {/* Hero Section */}
//       <section className="relative  from-primary-900 via-primary-800 to-primary-700 text-white py-20 bg-[url('../public/images/about/preview.png')] bg-center bg-cover bg-black/50 bg-blend-multiply">
...
//                         flex items-center justify-center shadow-lg transition-all duration-300 hover:cursor-pointer
//                         `}
//             aria-hidden
//           >
